    ...
    return (
        <nav className="bg-[#fffbf6] w-full fixed top-[0%] bottom-auto left-[0%] right-[0%] z-50 py-[8px] pl-[16px] md:pl-[40px] pr-[8px] md:pr-[20px] block lg:hidden border-[1px] border-[rgba(51, 51, 51, .2)]">
            ...
            <div className="absolute top-[100%] left-0 right-0 overflow-hidden lg:hidden block">
                <div className={`flex flex-col w-full gap-[20px] py-[20px] bg-[#fffbf6] font-noto-sans font-normal text-[16px] items-center border-b-[1px] border-x-[1px] border-[rgba(51, 51, 51, .2)] ${menu}`}>
